...
def get_lane_lines(color_image, solid_lines=True):
    # This function take as input a color road frame and tries to infer the lane 
    # lines in the image.
    # :param color_image: input frame
    # :param solid_lines: if True, only selected lane lines are returned.
    #                     If False, all candidate lines are returned.
